...
Used by Steam character creation (`steam/waifu_generator.html`) and overlay.  
**Artist guide:** [`docs/WAIFU_GEN_PAPERDOLL_ART_GUIDE.md`](../../../docs/WAIFU_GEN_PAPERDOLL_ART_GUIDE.md).  
Also see [`paperdoll/README.md`](paperdoll/README.md).
...
| `paperdoll/hair/{hairstyle}_{hair_color}.webp` | hairstyle × color (fallback: `{hairstyle}.webp`) |
| `paperdoll/eyes/{eye_shape}_{eye_color}.webp` | eyes composite (full matrix) |
