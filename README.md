...
## Что дальше
- Определить модели/схему БД (players, waifu, инвентарь, предметы, навыки, подземелья, гильдии, банк, лог боёв) и миграции Alembic.
- Реализовать доменные сервисы (бой, лут, магазин, таверна, гильдии, навыки).
