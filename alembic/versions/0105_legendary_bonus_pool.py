...
def _f5_combo_counter() -> list[tuple]:
    ...
    return [
        ...
        ("MILESTONE_25", "Четвертьсотня", "25-е сообщение за данж наносит ×8 урона.", g, "easy",
         {"handler": "counter", "mode": "milestone", "scope": "session", "n": 25, "effects": {"damage_multiplier": 8.0, "notification": "💥 25-й удар!"}}, True),
        ...
        ("MILESTONE_50", "Полусотня", "50-е сообщение за данж: ×10 урона и лечение 20% макс. HP.", g, "easy",
         {"handler": "counter", "mode": "milestone", "scope": "session", "n": 50, "effects": {"damage_multiplier": 10.0, "heal_pct_max_hp": 0.20, "notification": "🏅 Полусотня!"}}, True),
        ...
        ("CENTURION", "Центурион", "100-е сообщение за данж наносит ×20 урона.", g, "easy",
         {"handler": "counter", "mode": "milestone", "scope": "session", "n": 100, "effects": {"damage_multiplier": 20.0, "notification": "💯 Центурион!"}}, True),
    ]
