    ...
    tavern: {
      ...
      steps: [
        ...
        },
        {
          ...
          image: "excited",
          text: "Кнопка «Нанять» внизу экрана — первый найм бесплатный, дальше за золото. Получишь случайную наёмницу со случайной редкостью. Раса, класс и перки определяются автоматически.",
        },
      ],
    },
    dungeons: {
