...
GD_NARRATIVE_FORMATTING_RU = (
    ...
    "если у вайфу есть эпитет — сразу после имени « · <i>эпитет</i>» (тот же каждый удар, не крутить); "
    ...
    "Разрешены только теги <b>, </b>, <i>, </i>. "
    "Текст разбей на 2–3 абзаца с пустой строкой между ними — не одной стеной. "
    "Не выводи числа HP/урона; эффекты — словами. "
    "Пример: <b>Путютя</b> · <i>Клятвенная</i> с диким рыком обрушивает <b>Раскол Панциря</b> (урон), "
